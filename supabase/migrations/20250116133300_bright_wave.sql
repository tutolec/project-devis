/*
  # Nettoyage et consolidation du schéma de la base de données

  1. Tables
    - Suppression des tables existantes
    - Recréation des tables avec toutes les colonnes et contraintes nécessaires
...
DROP TABLE IF EXISTS specialized_outlets;
DROP TABLE IF EXISTS outlet_blocks;
DROP TABLE IF EXISTS lighting_fixtures;
DROP TABLE IF EXISTS rooms;
DROP TABLE IF EXISTS construction_forms;
